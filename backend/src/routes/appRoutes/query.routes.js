...
router.route('/queries/:id/notes').post(catchErrors(queryController.addNote));

router.route('/queries/:id/notes/:noteId').delete(catchErrors(queryController.deleteNote));
