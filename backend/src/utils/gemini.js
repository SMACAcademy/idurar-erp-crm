...
async function summarizeInvoiceNotes(notes) {
  try {
    ...
    const prompt = `Please summarize the following invoice item notes in a concise and professional manner. 
    Focus on key details, important points, and any special requirements or conditions mentioned.
