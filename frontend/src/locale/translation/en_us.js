const lang = {
  ...
  enter_resolution: 'Enter resolution',
  form_validation_error: 'Please fill in all required fields',
  failed_to_load_queries: 'Failed to load queries',
  query_created_success: 'Query created successfully',
  failed_to_create_query: 'Failed to create query',
  query_updated_success: 'Query updated successfully',
  failed_to_update_query: 'Failed to update query',
  query_deleted_success: 'Query deleted successfully',
